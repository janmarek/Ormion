...
class ManyToManyTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->db->query("insert into [pages]",
			array("name" => "Clanek", "description" => "Popis", "text" => "Text", "visits" => 0, "allowed" => true,),
			array("name" => "Article", "description" => "Description", "text" => "Text emericky.", "visits" => 5,
				"allowed" => false,), array("name" => "Nepovolený článek", "description" => "Popis nepovoleného článku",
				"text" => "Dlouhý text. By byl delší než tento.", "visits" => 3, "allowed" => false,),
			array("name" => "Jinačí článek", "description" => "Ryze alternativní popis", "text" => "Duchaplný text.",
				"visits" => 8, "allowed" => true,));

		$this->db->query("insert into [tags]", array("name" => "Osobní", "url" => "osobni",),
			array("name" => "Technologie", "url" => "technologie",),
			array("name" => "Společnost", "url" => "spolecnost",));
	}
	...
	public function testAdd()
	{
		$this->testSet();
		$page = Page::findByName("Clanek");
		$page->Tags[] = Tag::create(array("name" => "Luxusní zboží", "url" => "luxusni-zbozi",));
	...
	{
		$page = Page::create(
			array("name" => "English article", "description" => "Description", "text" => "Text in english.",
				"allowed" => true,));
